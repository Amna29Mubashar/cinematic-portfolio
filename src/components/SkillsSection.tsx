...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['Swift', 'SwiftUI', 'UIKit', 'Flutter', 'React Native', 'Dart', 'Objective-C', 'Combine', 'MVVM / MVC', 'SOLID', 'Offline-First', 'Multithreading'],
    description: 'Specialized in building production iOS and hybrid apps — from custom UI components to offline-first architecture and multithreaded systems.',
    stat: '7 APPS SHIPPED',
  ...
  },
  {
    title: 'BACKEND & CLOUD',
    badge: 'DATA & SYNC',
    items: ['Supabase', 'PostgreSQL', 'Firebase', 'REST APIs', 'Realm', 'CoreData', 'AWS', 'Amplify'],
    description: 'Engineered scalable backends and sync layers — from conflict-safe booking systems to offline persistence and cloud infrastructure.',
    stat: 'FULL-STACK OWNED',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'AI & AUTOMATION',
    badge: 'BUILDER TOOLS',
    items: ['Claude Code', 'AI-Assisted Development', 'LLM Feature Integration', 'AI-Powered Content'],
    description: 'Using AI-assisted development and LLM integrations to design, build, and ship products faster without cutting corners.',
    stat: 'AI-ENABLED',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'PRODUCT & INFRA',
    badge: 'END-TO-END',
    items: ['Figma', 'UX/UI Design', 'Roadmapping', 'Stripe SDK', 'Payment Terminals', 'CI/CD', 'TestFlight', 'Firebase Distribution', 'Datadog', 'CloudWatch', 'Git', 'Jira', 'Agile/Scrum'],
    description: 'Owning the full product lifecycle — from Figma concept and roadmap through CI/CD release pipelines and production monitoring.',
    stat: 'CONCEPT → RELEASE',
    colSpan: 'lg:col-span-7',
  },
];

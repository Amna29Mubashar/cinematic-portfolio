...
const journey: RouteStop[] = [
  {
    ...
    organization: 'UV APPS (REMOTE)',
    description: 'Founded and led product, design, and full-stack engineering for a mobile product studio; took multiple apps from concept through App Store/Play Store launch using Flutter and Supabase.',
  },
  {
    id: '02',
    year: 'JUN 2022 - PRESENT',
    title: 'SENIOR iOS DEVELOPER',
    organization: 'DEVSINC (USA)',
    description: 'Led iOS development across multiple client products (ExpoPass, HealHub, Maple HR), owning architecture, offline sync, and payments end-to-end.',
  },
  {
    id: '03',
    ...
    title: 'iOS DEVELOPER',
    organization: 'DEVSINC (USA)',
    description: 'Delivered iOS applications using Swift and Xcode with scalable, maintainable architecture.',
  },
  {
    id: '04',
